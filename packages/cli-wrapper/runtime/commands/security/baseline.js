import { readSecurityBaselineArtifact, showSecurityBaselineForPackage, summarizeSecurityBaseline } from '@zachariahredfield/playbook-engine';
...
const printBaselineText = (artifact) => {
    ...
    for (const finding of artifact.findings) {
        ...
        console.log(`- ${finding.package_name}@${finding.installed_version} ${finding.vulnerability_id} [${finding.severity}] ` +
...
export const runSecurityBaseline = async (cwd, args, options) => {
